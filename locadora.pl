...
opcao(5) :- write("Digite o codigo do Filme que deseja devolver:"),
			read(Cod),                         
...
realizaDevolucao(Codigo, Nome, Ano, Genero, Descricao) :- 	retract(alugado(filme(Codigo, Nome, Ano, Genero, Descricao))), % Realiza aluguel
															write("Filme está disponível na lista."). % Passa a mensagem de aluguel
